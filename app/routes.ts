...
export default [
  ...
  route('challenges/all', 'routes/challenges.all.tsx'),
  route('challenges/mine', 'routes/challenges.mine.tsx'),
  route('challenges/:range', 'routes/challenges.$range.tsx'),
  route('challenges', 'routes/challenges.tsx'),
  route('challenges/v/:id', 'routes/challenges.v.$id.tsx'),
