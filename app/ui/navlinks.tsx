  ...
  return (
    <>
      <div className="flex flex-col justify-start items-center h-screen min-h-full ">
        <div
          className={`w-24 flex items-center flex-col text-darkgrey text-center mb-4 p-2 rounded-lg ${location.pathname === '/' ? 'bg-gray-100' : 'hover:bg-gray-300'}`}
        >
          <Link
            to="/home"
        ...
        <div
          className={`w-24 h-20 flex items-center justify-center flex-col text-darkgrey text-center mt-4 mb-4 p-2 rounded-lg ${location.pathname === '/challenges' ? 'bg-gray-100' : 'hover:bg-gray-300'}`}
        >
          <Link
            to="/challenges"
            className="flex items-center flex-col"
        ...
        <div
          className="relative"
          onMouseEnter={toggleNewOpen}
          onMouseLeave={toggleNewOpen}
        >
          <div
            className={
              'w-24 h-20 flex items-center justify-center flex-col text-darkgrey text-center mt-4 mb-4 p-2 rounded-lg'
            }
          >
            <PlusCircleIcon
              className="h-8 w-8 cursor-pointer mb-1y text-red"
              onClick={() => {
        ...
        {currentUser?.role === 'ADMIN' && (
          <>
            <div
              className={`w-24 h-20 flex items-center justify-center flex-col text-darkgrey text-center mt-4 mb-4 p-2 rounded-lg ${location.pathname === '/challenges/mine' ? 'bg-gray-100' : 'hover:bg-gray-300'}`}
            >
              <Link
                to="/challenges/mine"
                className="flex items-center flex-col"
            ...
            <div
              className={`w-24 h-20 flex items-center justify-center flex-col text-darkgrey text-center mt-4 mb-4 p-2 rounded-lg ${location.pathname === '/challenges/all' ? 'bg-gray-100' : 'hover:bg-gray-300'}`}
            >
              <Link
                to="/challenges/all"
                className="flex items-center flex-col"
            ...
            <div
              className={`w-24 h-20 flex items-center justify-center flex-col text-darkgrey text-center mt-4 mb-4 p-2 rounded-lg ${location.pathname === '/admin' ? 'bg-gray-100' : 'hover:bg-gray-300'}`}
            >
              <Link
                to="/admin"
                className="flex items-center flex-col"
        ...
        {currentUser && (
          <div className="absolute bottom-10 left-0 w-24 h-20 text-darkgrey text-center mb-4 rounded-lg hover:bg-gray-300 flex flex-col items-center justify-center">
            <HiOutlineLogout
              className="h-8 w-8 cursor-pointer mb-1 text-darkgrey"
              onClick={logout}
            />
