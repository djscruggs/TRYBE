...
export default function CardChallengeMembership({
  membership,
}: CardChallengeProps): JSX.Element {
  ...
  return (
    <div className="mt-2 border-0 drop-shadow-none mr-2 w-full cursor-pointer">
      <div className="drop-shadow-none">
        <div
          className={
            "grid grid-cols-1 md:grid-cols-2 gap-4 rounded-md p-1 bg-white"
          }
        >
          <Card
            onClick={goToChallenge}
            className="md:col-span-2 bg-gray-200 p-2 border drop-shadow-lg border-gray rounded-md"
          >
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="flex flex-col items-center col-span-2">
                ...
                <Button
                  onClick={goToChallenge}
                  className="bg-red p-3 py-2 rounded-full mt-3 text-white"
                >
                  Check In
                </Button>
              </div>
