...
export default function LandingPage (): JSX.Element {
  ...
  return (
          <div className='relative w-screen max-w-[800px] h-svh items-start flex flex-col rounded-lg md:shadow-inner md:m-4  pt-4 md:pt-8 text-[#555555]'>
              ...
              <div className='relative w-full'>
                <div className='flex-col h-[600px] w-full items-center justify-center'>
                  ...
                  <div className='flex justify-center items-start  w-full mb-8'>
                    <img src="/images/landing/process.png" alt="process" className='h-[300px] mt-4' />
                  </div>
                  <NavigationDots step={step} />
              ...
              <div className='relative w-full'>
                <div className='flex-col h-[600px] w-full items-center justify-center'>
                  ...
                  <div className='flex justify-center items-start  w-full mb-2'>
                    <img src="/images/landing/improvement.png" alt="improvement" className='w-auto h-[200px]' />
                  </div>
