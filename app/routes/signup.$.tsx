...
function SignupNotice ({ onSignUp }: { onSignUp: () => void }): JSX.Element {
  return (
    <div className='flex flex-col items-center justify-center '>
      ...
      <p className='my-6 text-center text-lg w-3/4 md:w-1/2 text-[#696262]'>In order to join a challenge or created your own, an active Trybe account is required.</p>
